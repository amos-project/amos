...
import { Box, Dispatchable, Selectable, StoreEnhancer } from 'amos-core';
import { identity, isArray } from 'amos-utils';
 ...
 * @param options
 */
export function forceWithDevTools(options?: DevToolsOptions): any {
  ...
  return (StoreClass: any) => {
    ...
    return class extends StoreClass {
      ...
      protected _dispatch(tasks: Dispatchable | readonly Dispatchable[] | any): any[] {

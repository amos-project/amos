...
import { ShapedBox } from 'amos-core';
import {
...
> extends RecordObject<PagedListModel<any>>({
  ...
  delete(value: E): this {
    return clone(this, {
      ...
      pagedData: this.pagedData.searchUpdateOnce((v) => v.delete(value)),
    } as WellPartial<this>);
  }
}
...
export interface PagedListMapBox<PM extends PagedListMap<any>>
  extends ShapedBox<PM, 'deleteAt', never, RecordMapBox<PM>, PagedListMap<any>> {}

export const PagedListMapBox = RecordMapBox.extends<PagedListMapBox<any>>({
  name: 'PagedListMapBox',
  mutations: { deleteAt: null },
  selectors: {},
});

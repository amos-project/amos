...
export const setVisibleMode = action(
  (store, dispatch, visibleMode: TodoVisibleMode) => {
...
export const updateTodoAsync = action(
  async (store, dispatch, input: UpdateTodoAction) => {
